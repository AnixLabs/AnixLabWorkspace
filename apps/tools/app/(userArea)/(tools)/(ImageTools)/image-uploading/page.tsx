...
export const metadata = {
  ...
  description:
    "Upload and share your favorite images with ease using Anix Lab (formerly Anix7). Generate a shareable link and manage your images securely.",
  keywords: [
    "image uploader",
    "upload images",
    "image hosting",
    "Anix Lab Tools",
    "Anix7 Tools",
    "Anix Lab image uploader",
    "Anix7 image hosting",
    "Anix Lab image sharing",
    "image upload Anix Lab",
    "free image uploader",
    "online image hosting",
    "secure image sharing",
    "upload images Anix Lab",
    "share images Anix Lab Tools",
    "image URL generator",
    "image hosting service Anix Lab",
    "photo storage Anix Lab Tools",
    "image uploading and sharing",
    "easy image upload",
    "image hosting for websites",
    "upload and manage images Anix Lab",
    "cloud image storage Anix Lab",
    "Anix Lab image link generator",
    "free image sharing",
    "share images online",
    "photo storage",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Anix Lab Tools Image Uploading",
      },
    ],
    type: "website",
  },
