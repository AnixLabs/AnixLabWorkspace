...
export default async function SetPasswordPage({ params }: PageProps) {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      ...
      <form action={handleSetPassword} className="border rounded-xl p-6 bg-white dark:bg-neutral-900 shadow-sm space-y-4">
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium">New Password</label>
          <input name="password" type="password" placeholder="••••••••" required className="border rounded px-3 py-2 text-sm" />
        </div>
